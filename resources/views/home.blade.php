                                        ...
                                        <div class="card mb-4 shadow-sm">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="btn-group">
                                                        <a class="btn btn-sm btn-outline-secondary seeMore" href="{{route('article.show',['article' =>$city->id])}}">Voir l'article</a>
                                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mb-4 shadow-sm">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="btn-group">
                                                        <a class="btn btn-sm btn-outline-secondary seeMore" href="{{route('article.show',['article' =>$theme->id])}}">Voir l'article</a>
                                                    </div>
                            ...
                            <div class="row">
                                @foreach ($byColor as $color)
                                    <div class="col-md-4">
                                        <div class="card mb-4 shadow-sm">
                                            <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;" alt="icon article" style="height: 225px; width: 100%; display: block;"
                                                 src="{{asset('upload/'.$color->images[0]->url)}}" data-holder-rendered="true">
                                            <div class="card-body">
                                                <p class="card-text">
                                                    {{$color->title}}
                                                    <br>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="btn-group">
                                                        <a class="btn btn-sm btn-outline-secondary seeMore" href="{{route('article.show',['article' => $color->id])}}">Voir l'article</a>
                                                    </div>
